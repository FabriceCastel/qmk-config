...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_L0] = LAYOUT_ortho_4x12(
    KC_Q,    KC_W,        KC_E,         KC_R,        KC_T,   TG(_L3),  KC_NO,  KC_Y,   KC_U,        KC_I,         KC_O,        KC_P,
    KC_A,    CTL_T(KC_S), LGUI_T(KC_D), SFT_T(KC_F), KC_G,   KC_NO,    KC_NO,  KC_H,   SFT_T(KC_J), LGUI_T(KC_K), CTL_T(KC_L), KC_SCLN,
    KC_Z,    KC_X,        KC_C,         KC_V,        KC_B,   KC_NO,    KC_NO,  KC_N,   KC_M,        KC_COMM,      KC_DOT,      KC_SLSH,
    KC_PGUP, KC_PGDN,     KC_LGUI,      KC_LSFT,     L1_BSP, KC_LOPT,  KC_TAB, L2_SPC, CRL_QT,      KC_NO,        KC_NO,       KC_NO),
  ...
  [_L3] = LAYOUT_ortho_4x12(
    KC_ESC,  KC_M,    KC_W,    KC_I,    KC_NO, TG(_L3), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    KC_F1,   KC_A,    KC_S,    KC_D,    KC_L,  KC_NO,   KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,  KC_NO,   KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,  KC_NO,   KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO)
};